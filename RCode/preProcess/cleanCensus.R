...
ageList=c("Under 5 years","5 to 9 years","10 to 14 years","15 to 17 years","18 and 19 years")
...
finalRaceList=list("white"="(WHITE ALONE, NOT HISPANIC OR LATINO)",
                   ...
                   "asian"="(ASIAN ALONE)",
                   "multiracial_white"="(TWO OR MORE RACES)",
                   "other"=c("(AMERICAN INDIAN AND ALASKA NATIVE ALONE)","(NATIVE HAWAIIAN AND OTHER PACIFIC ISLANDER ALONE)","(SOME OTHER RACE ALONE)"))
...
fwrite(censusMeltFinal,"censusWeights.txt",sep="\t")
